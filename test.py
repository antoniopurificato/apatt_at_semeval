...
if args.ensemble == 'False':
  my_df.to_csv('lightning_logs/test_{}_{}_{}.txt'.format(args.model,args.language,threshold_str),header=None, index=None, sep='\t')
else:
  my_df.to_csv('lightning_logs/test_ensemble_{}_{}.txt'.format(args.language,threshold_str),header=None, index=None, sep='\t')

if args.ensemble == 'False':
  bashCommand = "python3 semeval2023task3bundle-v3/scorers/scorer-subtask-3.py --techniques_file_path semeval2023task3bundle-v3/scorers/techniques_subtask3.txt  --pred_file_path lightning_logs/" + 'test_{}_{}_{}.txt'.format(args.model,args.language,threshold_str) + " --gold_file_path semeval2023task3bundle-v3/data/" + str(args.language) + "/dev-labels-subtask-3.txt"
else:
  bashCommand = "python3 semeval2023task3bundle-v3/scorers/scorer-subtask-3.py --techniques_file_path semeval2023task3bundle-v3/scorers/techniques_subtask3.txt  --pred_file_path lightning_logs/" + 'test_ensemble_{}_{}.txt'.format(args.language,threshold_str) + " --gold_file_path semeval2023task3bundle-v3/data/" + str(args.language) + "/dev-labels-subtask-3.txt"
...
my_df.to_csv('lightning_logs/results.txt',mode='a', index=None,header = None, sep='\t')

os.chdir("lightning_logs")
if args.ensemble == 'False':
